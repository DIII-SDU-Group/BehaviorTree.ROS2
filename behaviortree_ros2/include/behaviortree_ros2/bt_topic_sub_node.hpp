...
protected:
  ...
  {
    SubscriberInstance(std::shared_ptr<rclcpp::Node> node, const std::string& topic_name, rclcpp::QoS qos_profile);
...
inline RosTopicSubNode<T>::SubscriberInstance::SubscriberInstance(
    std::shared_ptr<rclcpp::Node> node, const std::string& topic_name, rclcpp::QoS qos_profile)
{
...
inline bool RosTopicSubNode<T>::createSubscriber(const std::string& topic_name)
{
  ...
  {
    sub_instance_ = std::make_shared<SubscriberInstance>(node, topic_name, qos_profile_);
